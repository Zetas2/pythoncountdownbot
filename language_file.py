translations = {
    ...
    "en-US": {
        ...
        "helpCountdownTitle": "</countdown:1015705055296503910>",
        ...
        "helpHelpTitle": "</help:1015705055296503909>",
        ...
        "helpCommonTimeTile": "Example timestring formats:",
        "helpCommonTimeDesc": "Sep 17, 2023 11:00PM GMT+0900\n5 days 4 hours 3 minutes",
        ...
        "helpFooter7": "Thanks Towering Falcon for being crazy",
        "helpFooter8": "Thanks Zetas2 for translating to english",  # Edit to your name and language
        ...
        "premiumMultipleDesc": "Yes, we offer multiple tiers that allow different amounts of premium servers.\n• 3$ for 1 server\n• 5$ for up to 2 servers\n• 10$ for up to 5 servers\n• 20$ for up to 12 servers\n• 70$ for up to 50 servers",
        "premiumPickTitle": "How do I pick what guild?",
        "premiumPickDesc": "You will be able to add your servers using `/makethispremium index:#`. This will lock in the server you are running it on to that number up to the amount of servers you paid for.. \n**BEWARE!** There is a cooldown between uses of it on a single server.",
        ...
        "deleteConfirmMine": "Are you sure you want to delete all your countdowns in this guild?",
        "deleteConfirmGuild": "Are you sure you want to delete all countdowns in this guild?",
        "deleteConfirmChannel": "Are you sure you want to delete all countdowns in this channel?",
